<template>
    <div class="w-full h-full">
        <el-container class="w-full h-full">
            <el-header class=" bg-#88888-900 text-white" style="height: 90px; display: flex; justify-content: space-between;"> 
                <div class="w-full h-full flex items-center justify-between" style="background-color: #263544;">                   
                    ...
                    <div style="margin-right: 10px;">
                        ...
                        <template v-if="$store.state.isLoggedIn">
                            ...
                            <br>
                            <el-button type="text" @click="goToLogout" style="margin-right: 10px;">退出</el-button>
                        </template>
                        <template v-else>
                            <el-button type="text" @click="goToLoginOrRegister" style="margin-right: 10px;">登录/注册</el-button>
                        </template>
                    </div>
                </div>
            </el-header>
